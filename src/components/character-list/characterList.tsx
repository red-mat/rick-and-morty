...
interface iProps {characterList:iCharacterApiResult[], cardClick:tCardClick};

// Retorna la lista de personaje
export default function CharacterList({ characterList, cardClick }:iProps):JSX.Element {
  return (
